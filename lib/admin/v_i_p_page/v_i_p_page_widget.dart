...
import 'v_i_p_page_model.dart';
export 'v_i_p_page_model.dart';
...
class _VIPPageWidgetState extends State<VIPPageWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VIPPageModel());
                                  ...
                                  Padding(
                                    ...
                                    child: AuthUserStreamWidget(
                                      builder: (context) => Container(
                                        width: 100.0,
                                        decoration: BoxDecoration(
                                          color: currentUserDocument?.vipColor,
