...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFFA01809);
  late Color tertiary = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFF1E222B);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFF999999);
  late Color primaryBackground = const Color(0xFF14181D);
  late Color secondaryBackground = const Color(0xFF1E222B);
  late Color accent1 = const Color(0xFF111111);
  late Color accent2 = const Color(0xFF86100F);
  late Color accent3 = const Color(0x4DEE8B60);
  late Color accent4 = const Color(0xFF35373B);
